                    ...
                    <div class="col-md-6 mb-4"> <!-- Display 2 items per row with margin-bottom -->
                        <div class="destination-item">
                            <div class="destination-img">
                                <img src="' . base_url('uploads/resorts/' . $resort['main_image']) . '" alt="' . $resort['name'] . '" class="img-fluid img-fluid top-rounded-img">
                            </div>
                            <div class="destination-content">
                                <h3>' . $resort['name'] . '</h3>
                                <p>' . $description . '</p>
                               ' . (!empty($resort['external_url']) ? '
    <a class="btn btn-primary" href="' . $resort['external_url'] . '" target="_blank" rel="noopener noreferrer">
        Read more
    </a>' : '') . '
                            </div> 
