      ...
      <div class="right_col" role="main">
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <form method="post" action="/webmaster/chatbot/update/<?= $chatbot['id'] ?>">
                <label>Keywords</label><br>
                <input type="text" name="keywords" value="<?= $chatbot['keywords'] ?>" required><br><br>
            
                <label>Answer</label><br>
                <textarea name="answer" required><?= $chatbot['answer'] ?></textarea><br><br>
