              ...
              <div class="right_col" role="main">
                <div class="">
                  ...
                  <div class="row">
                    ...
                    <form id="" action="<?= site_url('update-voucher/' . $voucher['tbl_id']) ?>" method="post" class="form-horizontal form-label-left">
                    ...
                    <?php foreach ($offer as $offerItem): ?>
                        <label class="control-label col-md-2 col-sm-2 col-xs-12">ID No.</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="number" name="tbl_id" class="form-control col-md-7 col-xs-12" value="<?= htmlspecialchars($offerItem['id']); ?>" readonly>
