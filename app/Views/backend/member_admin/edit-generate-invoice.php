        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border:0;">
                    <a href="#" class="site_title"><span>Edit Invoice</span></a>
                </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <form action="<?= site_url('invoice/updateData/' . $invoice['id']) ?>" class="form-horizontal form-label-left" method="post">
                  <!-- Hidden Invoice ID -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                          <input type="date" name="gen_date" class="form-control" value="<?= $invoice['gen_date'] ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                          <input type="text" name="bank" class="form-control" value="<?= $invoice['bank'] ?>">
                        </div>

                        <label class="control-label col-md-2">TID</label>
                        <div class="col-md-4">
                          <input type="text" name="tid" class="form-control" value="<?= $invoice['tid'] ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                          <input type="text" name="mode" class="form-control" value="<?= $invoice['mode'] ?>">
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <select name="payment_type" class="form-control" required>
                          ...
                          <option value="Holiday Amount" <?= $invoice['payment_type'] === 'Holiday Amount' ? 'selected' : '' ?>>Holiday Amount</option>
                          <option value="Annual Maintenance Cost" <?= $invoice['payment_type'] === 'Annual Maintenance Cost' ? 'selected' : '' ?>>Annual Maintenance Cost</option>
                          <option value="Utility Charges" <?= $invoice['payment_type'] === 'Utility Charges' ? 'selected' : '' ?>>Utility Charges</option>
                        </select>
                      </div>

                      <label class="control-label col-md-2">Card No.</label>
                      <div class="col-md-4">
                        <input type="text" name="card_num" class="form-control" value="<?= $invoice['card_num'] ?>">
                      </div>
                    </div>
