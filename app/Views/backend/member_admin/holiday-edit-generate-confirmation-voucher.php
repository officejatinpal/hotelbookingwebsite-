    ...
    ?>
        ...
        <?php endif; ?>
              ...
              <div class="right_col" role="main">
                <div class="">
                  ...
                  <div class="row">
                    ...
                    <form id="" action="<?= site_url('holiday/voucher/update/' . $voucher['tbl_id']) ?>" method="post" class="form-horizontal form-label-left">
                    <input type="hidden" name="tbl_id" value="<?= $voucher['tbl_id'] ?>">
                    <div class="form-group">
                        <label class="control-label col-md-1 col-sm-1 col-xs-12">Confirmed By</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="text" name="confirm_by" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['confirm_by']); ?>">
                            <div class="confErr"></div>
                        </div>
                        <?php if (!empty($holiday) && is_array($holiday)): ?>
                    <?php foreach ($holiday as $holiday): ?>
                        <label class="control-label col-md-2 col-sm-2 col-xs-12">ID No.</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="number" name="tbl_id" class="form-control col-md-7 col-xs-12" value="<?= ($holiday['id']); ?>" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="text" name="book_id" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['book_id']); ?>" />
                            <div class="bookIdErr"></div>
                        </div>
                        <label class="control-label col-md-2 col-sm-2 col-xs-12">Deduction Amount</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="number" name="deduction_amount" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['deduction_amount']); ?>">
                            <div class="deductamtErr"></div>
                        </div>                                           
                    </div>
                    ...
                    <div class="form-group">                        
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="number" name="book_amount" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['book_amount']); ?>">
                            <div class="bookamtErr"></div>
                        </div>
                        <label class="control-label col-md-2 col-sm-2 col-xs-12">Received Amount</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="number" name="received_amount" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['received_amount']); ?>">
          ...
          <div class="form-group">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="text" name="destination" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['destination']); ?>">
                  <div class="destiErr"></div>
              </div>
              
              <label class="control-label col-md-2 col-sm-2 col-xs-12">Property Name</label>
              <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="text" name="property_name" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['property_name']); ?>">
          ...
          <div class="form-group">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="text" name="location" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['location']); ?>">
                  <div class="locErr"></div>
              </div>
              
              <label class="control-label col-md-2 col-sm-2 col-xs-12">Contact</label>
              <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="text" name="contact_num" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['contact_num']); ?>">
          ...
          <div class="form-group">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="text" name="book_from" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['book_from']); ?>">
          ...
          <div class="form-group">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="text" name="room_type" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['room_type']); ?>">
                  <div class="rtErr"></div>
              </div>                        

              <label class="control-label col-md-2 col-sm-2 col-xs-12">No. of Rooms</label>
              <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="number" min="1" name="no_of_room" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['no_of_room']); ?>">
                  <div class="rnErr"></div>
              </div>                        
          </div>
          ...
          <div class="form-group">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="text" name="includes" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['includes']); ?>">
          ...
          <div class="form-group">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="number" min="1" name="adults" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['adults']); ?>">
                  <div class="adultErr"></div>
              </div>
              
              <label class="control-label col-md-2 col-sm-2 col-xs-12">No. of Children</label>
              <div class="col-md-4 col-sm-4 col-xs-12">
                  <input type="text" name="kids" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['kids']); ?>">
                  <div class="childErr"></div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-4 col-sm-4 col-xs-12">
                                  <input type="date" name="check_in" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['check_in']); ?>">
                                  <div class="chinErr"></div>
                              </div>
                              
                              <label class="control-label col-md-2 col-sm-2 col-xs-12">Check-Out Date</label>
                              <div class="col-md-4 col-sm-4 col-xs-12">
                                  <input type="date" name="check_out" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['check_out']); ?>">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="time" name="check_in_time" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['check_in_time']); ?>">
                            <div class="cinTErr"></div>
                            </div>
                            
                            <label class="control-label col-md-2 col-sm-2 col-xs-12">Out Time</label>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                            <input type="time" name="check_out_time" class="form-control col-md-7 col-xs-12" value="<?= ($voucher['check_out_time']); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="tbl_id" value="">
                                    ...
                                    <a href="/search_member" class="btn btn-primary">Back</a>
                                </div>
                            </div>
                        </form>
