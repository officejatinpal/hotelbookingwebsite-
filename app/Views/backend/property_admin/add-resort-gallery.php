<?php
    ...
    $btnname = "Submit";
    $task = "insert"; 
    $title = 'Add gallery image : '.$res_name[0]->name;
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="#" class="site_title"><span></span><?=WEB_TITLE?></a>
            </div>
    ...
    <form id="add_form"  class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input  type="file" name="image[]" multiple accept="image/*" class="form-control col-md-7 col-xs-12">
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $('.submit').on('click', function(e){
          ...
          var url = '<?=base_url()."webmaster/add_gallery_process/"?>'+task;
