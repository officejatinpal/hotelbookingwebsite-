          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form action="<?= base_url('webmaster/pagevoucher'); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                    ...
                    <div class="col-md-4">
                       <input type="file" id="image" name="image" class="form-control" accept="image/*,.pdf">
