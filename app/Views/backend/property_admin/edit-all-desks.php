          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form action="<?= base_url('webmaster/deskupdate/'.$desk['id']); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                  <!-- Resort Title -->
                  <div class="form-group">
                    <label for="title" class="control-label col-md-2">Title</label>
                    <div class="col-md-4">
                        <input type="text" id="title" name="title" class="form-control" value="<?= old('title', $desk['title']); ?>" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" id="slug" name="slug" class="form-control" value="<?= old('slug', $desk['slug']); ?>" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" id="meta_description" name="meta_description" class="form-control" value="<?= old('meta_description', $desk['meta_description']); ?>" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <?php if (isset($desk['image']) && $desk['image']): ?>
                    <div>
                        <img src="<?= base_url('uploads/traveldesk/' . $desk['image']); ?>" alt="Featured Image" width="100">
                        <input type="hidden" name="existing_image" value="<?= $desk['image'] ?>">
                        <p>Current Image</p>
                    </div>
                    <?php endif; ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea id="content" name="content" class="form-control" rows="5" required><?= old('content', $desk['content']); ?></textarea>
