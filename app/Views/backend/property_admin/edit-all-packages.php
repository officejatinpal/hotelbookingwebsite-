          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form action="<?= base_url('webmaster/blogupdate/'.$blog['id']); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                  <!-- Resort Title -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" id="meta_description" name="meta_description" class="form-control" value="<?= old('meta_description', $blog['meta_description']); ?>" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <div>
                        <img src="<?= base_url('uploads/blogs/' . $package['image']); ?>" alt="Featured Image" width="100">
