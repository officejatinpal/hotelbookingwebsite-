...
<div class="invoice-content">
    ...
    <div>
        ...
        <span class="highlight"><?= $status=='success' ? esc($payment_id) : 'N/A' ?></span>
    </div>
    <div>
        <strong>Date:</strong> 
    ...
    <div>
        <strong>Total:</strong> 
        <span class="highlight">₹<?= isset($amount) ? number_format($amount, 2) : '0.00' ?></span>
    </div>
    ...
    <div class="table-box">
        ...
        <div class="row">
            ...
            <div class="col-right"><?= esc($name ?? 'N/A') ?></div>
        </div>

        <div class="row">
            <div class="col-left">Email Id:</div>
            <div class="col-right"><?= esc($email ?? 'N/A') ?></div>
        </div>

        <div class="row">
            <div class="col-left">Phone No.:</div>
            <div class="col-right"><?= esc($phone ?? 'N/A') ?></div>
        </div>

        <div class="row">
            <div class="col-left">Payment Type:</div>
            <div class="col-right"><?= esc($type ?? 'N/A') ?></div>
        </div>

        <div class="row">
            <div class="col-left">Payment Gateway:</div>
            <div class="col-right">Razorpay</div>
        </div>
